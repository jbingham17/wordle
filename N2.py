...
# t = ['alarm', 'award', 'braid', 'brain', 'brand', 'brash', 'brass', 'brawl', 'brawn', 'chair', 'chard', 'charm', 'crack', 'cramp', 'crank', 'crash', 'crass', 'crawl', 'crazy', 'diary', 'drain', 'drama', 'drank', 'drawl', 'drawn', 'dwarf', 'flair', 'frail', 'frank', 'fraud', 'grail', 'grain', 'grand', 'graph', 'grasp', 'grass', 'gravy', 'guard', 'prank', 'prawn', 'quark', 'scarf', 'scary', 'shard', 'shark', 'sharp', 'snarl', 'spark', 'swarm', 'wharf', 'wrack']
